...
const Navbar = ({ isHome }) => {
  return (
    <section className="relative pt-1 lg:pt-5">
      <section
        className={` mx-2 lg:mx-10 rounded-lg lg:rounded-3xl ${
          isHome
            ? "text-white h-[380px] lg:h-[520px] bg-[#9538E2]"
            : "text-black"
        }`}
      >
        <div className="navbar lg:px-16 pt-1 lg:pt-4">
          <div className="navbar-start">
            ...
            <a
              className={`btn btn-ghost text-xl px-0 mx-0 ${
          ...
          <div className="navbar-center hidden lg:flex">
            <ul
              className={`menu-horizontal px-1 font-semibold ${
                isHome ? "text-white" : "text-black"
              }`}
            >
              <li>
                <NavLink
                  ...
                  className={({ isActive, isPending }) =>
                    isPending ? "bg-green-600" : isActive ? "underline" : ""
                  }
                >
                  Home
                </NavLink>
        ...
        <div
          className={`lg:w-[50%] mx-auto flex-col justify-center ${
            isHome ? "flex" : "hidden"
          }`}
        >
      ...
      <div
        className={`justify-center absolute left-1/2 transform -translate-x-1/2 top-80 lg:top-96 h-[220px] lg:h-[420px] w-[300px] lg:w-[800px] border-2 bg-[#ffffff6c] rounded-xl ${
          isHome ? "flex" : "hidden"
        }`}
      >
        <img
